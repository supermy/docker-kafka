...
RUN wget  http://apache.fayea.com/kafka/0.8.2.2/kafka_2.11-0.8.2.2.tgz -O /tmp/kafka_2.11-0.8.2.2.tgz

RUN tar xfz /tmp/kafka_2.11-0.8.2.2.tgz -C /opt

RUN rm /tmp/kafka_2.11-0.8.2.2.tgz

VOLUME ["/kafka"]

ENV KAFKA_HOME /opt/kafka_2.11-0.8.2.2
